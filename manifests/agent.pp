...
class zabbix::agent (
  ...
  Optional[Variant[String[1],Array[String[1]]]] $allowkey = $zabbix::params::agent_allowkey,
  Optional[Variant[String[1],Array[String[1]]]] $denykey = $zabbix::params::agent_denykey,
